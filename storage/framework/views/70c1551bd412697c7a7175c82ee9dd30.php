...
<body>
    ...
    <?php $__currentLoopData = $selectedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span style="list-style-type: none;"><?php echo e('Invoice for orderid : '. $orderId); ?></span>
        <br><br><br><br>
        ...
        <div class="invoice-details">
            ...
            <p><strong>Attn:</strong> Dr. Rebecca Gomperts</p>
            <p><strong>Address:</strong> 1701 North State Street, Theresienbadgasse 4/3, Jackson, MS 39202, 1120 Wien,
                Austria</p>
...
<?php /**PATH /var/www/html/CompletedProjectsSPX066/admin_panel/resources/views/pdf/invoicepdfshipped.blade.php ENDPATH**/ ?>