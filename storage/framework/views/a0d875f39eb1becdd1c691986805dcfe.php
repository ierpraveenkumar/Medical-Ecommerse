...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto my-10 p-6 bg-white rounded-md shadow-md">
        ...
        <?php if(session('errorshipto')): ?>
            <div style="background: hsl(226, 94%, 46%)" class="alert">
                <?php echo e(session('errorshipto')); ?>

            </div>
        <?php endif; ?>

        
        <?php if(session('errorinvoice')): ?>
            <div style="background: hsl(224, 83%, 12%)" class="alert">
                <?php echo e(session('errorinvoice')); ?>
        ...
        <div class="flex space-x-4 mb-4">
            ...
            <form class="bg-blue-500 text-white px-4 py-2 rounded-md" id="importForm" action="<?php echo e(route('orders.import')); ?>"
                        ...
                        <?php if($lead->order): ?>
                            <tr>
                                <td class="py-2 px-4"><input type="checkbox" name="selectedOrders[]"
                                        value="<?php echo e($lead->order->id); ?>"></td>
                                <td class="py-2 px-4"><?php echo e($lead->order->id ?? ''); ?></td>
                                <td class="py-2 px-4"><?php echo e($lead->first_name); ?> <?php echo e($lead->last_name); ?></td>
                                <td class="py-2 px-4"><?php echo e($lead->order->shipping_address ?? ''); ?></td>
                                <td class="py-2 px-4"><?php echo e($lead->order->invoice->id ?? ''); ?></td>
                                <td class="py-2 px-4"><?php echo e($lead->order->created_at->format('d-m-Y') ?? ''); ?></td>
                                <td> <a class="py-2 px-4"
                                        href="<?php echo e(route('show-latest-order', $lead->order->id)); ?>">View</a></td>
                            </tr>
                        <?php endif; ?>
            ...
            $(document).ready(function() {
                $('#formsub').click(function(e) {
                    ...
                    //if rows selected
                        ...
                        // Send AJAX request
                        $.ajax({
                            url: '<?php echo e(route('orders.exportSelected')); ?>',
                            type: 'POST',
                            data: formData,
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                bulkExportButton.addEventListener('click', function() {
                    ...
                    form.action =
                        '<?php echo e(route('bulk.export.prescription')); ?>'; // Change the action to the desired route
                    form.submit();
                });
            });
        </script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                shippingfrom.addEventListener('click', function() {
                    ...
                    form.method = 'post'; // Change the method to POST
                    form.action =
                        '<?php echo e(route('export.shipping.lable.from')); ?>'; // Change the action to the desired route
                    form.submit();
                });
            });
        </script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                shippingfrom.addEventListener('click', function() {
                    ...
                    form.method = 'post'; // Change the method to POST
                    form.action =
                        '<?php echo e(route('export.shipping.lable.to')); ?>'; // Change the action to the desired route
                    form.submit();
                });
            });
        </script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                selectedinvoice.addEventListener('click', function() {
                    ...
                    // Submit the form
                    form.method = 'post'; // Change the method to POST
                    form.action = '<?php echo e(route('orders.invoices')); ?>'; // Change the action to the desired route
                    form.submit();
                });
            });
        </script>
    ...
    <div style="display: none">
        <a href="<?php echo e(route('razorpay')); ?>">Checkout via razorpay</a>
        <a href="<?php echo e(route('createTransaction')); ?>">Checkout via paypal</a>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/CompletedProjectsSPX066/admin_panel/resources/views/Admin/Pages/manage-latest-orders.blade.php ENDPATH**/ ?>