    ...
    <div class="container mx-auto my-10 p-6 bg-white rounded-md shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="mb-4">
                ...
                <p class="text-base text-gray-900">{{ $lead->first_name }} {{ $lead->last_name }}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-base text-gray-900">{{ $lead->payment_link ? 'Yes' : 'No' }}</p>
            </div>

            <div class="mb-4">
                <p class="text-lg font-semibold mb-2 text-gray-700">Generated On:</p>
                <p class="text-base text-gray-900">{{ $lead->generated_on }}</p>
            </div>

            <div class="mb-4">
                <p class="text-lg font-semibold mb-2 text-gray-700">Converted To Orders Or Not?:</p>
                <p class="text-base text-gray-900">{{ $lead->converted_to_order ? 'Yes' : 'No' }}</p>
            </div>
        </div>
